        ...
        <div className="container mx-auto py-10">
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
              <div class="max-w-[570px] bg-white py-10 px-8 sm:p-12 md:p-[60px]">
                <span class="block mb-3 text-base font-medium text-mi-naranja">
                  Auditores Independientes
                </span>
                <h1 class="mb-3 text-3xl font-bold leading-[1.208] text-dark md:text-4xl">
                  PSH Auditores &amp; Asociados.
                </h1>
                <p class="mb-8 text-base font-medium text-body-color lg:mb-10">
                ...
                <div class="flex flex-wrap gap-3">
                  <a href="javascript:void(0)" class="py-3 text-base font-medium text-white transition bg-mi-naranja px-7 hover:bg-blue-dark">
                    Saber más
                  </a>
                  <a href="javascript:void(0)" class="inline-flex items-center px-6 py-3 text-base font-medium bg-white shadow-1 dark:shadow-none text-dark hover:text-mi-naranja">
                    Explorar Servicios
                    <span class="ml-2">
